...
<?if(strlen($arResult["ERROR_MESSAGE"])<=0):?>
	...
	<tr>
		<td align="right"><?=GetMessage("P_ORDER_PERS_TYPE")?>:</td>
	...
	if (strlen($arResult["USER_DESCRIPTION"])>0) {
		...
		<tr>
			<td align="right"><?=GetMessage("P_ORDER_USER_COMMENT")?>:</td>
	...
	<tr>
		...
		?>
			...
			<tr>
				...
				<td align="right" colspan="2"><?=$arResult["DISCOUNT_VALUE_FORMATED"]?></td>
			</tr>
			<?endif;?>
			<?
			foreach($arResult["TAX_LIST"] as $val) {
				...
				<tr>
					...
					<td align="right"><?
						...
						?>:</td>
					<td align="right" colspan="2"><?=$val["VALUE_MONEY_FORMATED"]?></td>
				</tr>
				<?
			}
			?>
			...
			<tr>
				...
				<td align="right" colspan="2"><?=$arResult["TAX_VALUE_FORMATED"]?></td>
			</tr>
			<?endif;?>
			...
			<tr>
				...
				<td align="right" colspan="2"><?=$arResult["PRICE_DELIVERY_FORMATED"]?></td>
			</tr>
			<?endif;?>
			<tr>
                   <td></td>
				<td align="right"><b><?=GetMessage("SPOD_ITOG")?>:</b></td>
				<td align="right" colspan="2"><?=$arResult["PRICE_FORMATED"]?></td>
			</tr>
        </table>
<?else:?>
